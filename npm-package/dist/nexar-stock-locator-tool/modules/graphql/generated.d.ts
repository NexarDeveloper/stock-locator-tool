...
export declare enum DatBomAnalysisLevel {
    Error = "ERROR",
...
export declare enum DatBomAnalysisResultLevel {
    Error = "ERROR",
    Suggestion = "SUGGESTION",
    Warning = "WARNING"
}
...
export declare enum DatBomPartSearchStrategy {
    Exact = "EXACT",
    Fuzzy = "FUZZY",
    Partial = "PARTIAL"
}
...
export declare enum DatScrJobState {
...
export declare enum DesContentTypeKind {
...
export declare enum DesJobStatus {
    Done = "DONE",
    Error = "ERROR",
    Pending = "PENDING",
...
export declare enum DesLayerType {
    Abstract = "ABSTRACT",
    Adhesive = "ADHESIVE",
...
export declare enum DesPadType {
    Free = "FREE",
    Smd = "SMD"
}
export declare enum DesParameterType {
...
export declare enum DesPinElectricalType {
    HiZ = "HI_Z",
    Input = "INPUT",
    Io = "IO",
...
export declare enum DesPrimitiveShape {
    Rectangle = "RECTANGLE",
    Round = "ROUND",
...
export declare enum DesTaskPriority {
    High = "HIGH",
    Highest = "HIGHEST",
    Low = "LOW",
    Medium = "MEDIUM",
...
export declare enum DesTaskStatus {
...
export declare enum DesUserPictureSize {
    Original = "ORIGINAL",
    Size48X48 = "SIZE48X48",
    Size70X70 = "SIZE70X70",
...
export declare enum ManCurrency {
    Usd = "USD"
}
...
export declare enum ManLayerType {
    Core = "CORE",
    Coverlay = "COVERLAY",
    Overlay = "OVERLAY",
    Plane = "PLANE",
...
export declare enum ManMountingType {
...
export declare enum ManOrderEventType {
    Accepted = "ACCEPTED",
    Batched = "BATCHED",
    Cancel = "CANCEL",
...
export declare enum ManOrderStatus {
    Cancelled = "CANCELLED",
    Complete = "COMPLETE",
...
export declare enum ManPartIssue {
...
export declare enum ManPartStatus {
    Good = "GOOD",
    Issue = "ISSUE",
    Warn = "WARN"
}
...
export declare enum ManPathType {
    Arc = "ARC",
    Vertex = "VERTEX"
}
export declare enum ManPaymentMethod {
...
export declare enum ManQuoteCategory {
    Assembly = "ASSEMBLY",
    Bom = "BOM",
...
export declare enum ManShippingCarrier {
    Ups = "UPS",
    Usps = "USPS"
}
...
export declare enum ManSide {
    Bottom = "BOTTOM",
    Top = "TOP"
}
export declare enum ManSilkScreenColour {
    Black = "BLACK",
    Blue = "BLUE",
    Green = "GREEN",
    Red = "RED",
...
export declare enum ManSolderMaskColour {
    Black = "BLACK",
    Blue = "BLUE",
...
export declare enum ManSourcing {
    Altimade = "ALTIMADE",
    Consign = "CONSIGN",
    Dnp = "DNP"
}
...
export declare enum ManViolationType {
...
export declare enum SupNexarFeatureId {
...
export declare enum SupPartLifeCycle {
    Active = "ACTIVE",
...
export declare enum SupPlanTier {
    Basic = "BASIC",
...
export declare enum SupRole {
    Cadmodels = "CADMODELS",
    Distributor = "DISTRIBUTOR",
    Internal = "INTERNAL",
    Nexarinternal = "NEXARINTERNAL"
}
export declare enum SupSortDirection {
    Asc = "asc",
    Desc = "desc"
}
...
export type MpnSearchQuery = {
    ...
    supSearchMpn: {
        ...
        results?: Array<{
            __typename?: 'SupPartResult';
            _cacheId: string;
            akaMpn?: string | undefined;
            description: string;
            part: {
                __typename?: 'SupPart';
                _cacheId: string;
                freeSampleUrl?: string | undefined;
                id: string;
...
export declare const MpnSearchDocument: Apollo.DocumentNode;
/**
 ...
 * });
 */
export declare function useMpnSearchQuery(baseOptions: Apollo.QueryHookOptions<MpnSearchQuery, MpnSearchQueryVariables>): Apollo.QueryResult<MpnSearchQuery, Exact<{
    q?: InputMaybe<string>;
    country: string;
    currency: string;
    start?: InputMaybe<number>;
    limit?: InputMaybe<number>;
    sortDir?: InputMaybe<SupSortDirection>;
    inStockOnly?: InputMaybe<boolean>;
    filters?: any;
    distributorApi?: InputMaybe<boolean>;
    distributorApiTimeout: string;
    authorizedOnly: boolean;
}>>;
export declare function useMpnSearchLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MpnSearchQuery, MpnSearchQueryVariables>): Apollo.LazyQueryResultTuple<MpnSearchQuery, Exact<{
    q?: InputMaybe<string>;
    country: string;
    currency: string;
    start?: InputMaybe<number>;
