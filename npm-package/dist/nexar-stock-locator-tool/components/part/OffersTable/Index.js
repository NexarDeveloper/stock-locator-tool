    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        ...
        react_1.default.createElement(
          "tr",
          null,
          !(hideColumns === null || hideColumns === void 0
            ? void 0
            : hideColumns.isAuthorized) &&
            react_1.default.createElement("th", {
              style: { width: "22px", color: theme.tableHeaderText },
            }),
          !(hideColumns === null || hideColumns === void 0
            ? void 0
            ...
            react_1.default.createElement(
              "th",
              { style: { width: "18.1%", color: theme.tableHeaderText } },
              "Distributor"
            ),
          !(hideColumns === null || hideColumns === void 0
            ? void 0
          ...
          !(hideColumns === null || hideColumns === void 0
            ...
            react_1.default.createElement(
              "th",
              { style: { textAlign: "right", color: theme.tableHeaderText } },
              "Stock"
            ),
          !(hideColumns === null || hideColumns === void 0
            ? void 0
          ...
          !(hideColumns === null || hideColumns === void 0
            ? void 0
            : hideColumns.cta) && react_1.default.createElement("th", null),
          !(hideColumns === null || hideColumns === void 0
            ? void 0
      ...
      react_1.default.createElement(
        "tbody",
        null,
        sellers.map(function (seller, sellerIndex) {
...
var StyledOffersTable = styled_components_1.default.div(
  templateObject_1 ||
