...
export const GpaTool = ({ searchParameters, styles, hideColumns }) => {
    var _a;
    ...
    return (React.createElement(Gpatool, { style: { fontFamily: `${font}`, backgroundColor: `${theme.background}` } },
